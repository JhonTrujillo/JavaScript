...
un numero par o impar en un for loop... */
for(let i = 0; i <= 10; i++) {
    if(i % 2 == 0) {
...
/* en este caso nuestro for loop corre hasta que una condición se cumple, ahora como este arreglo el 
usuario  se va a encargar de llenarlo, que el carrito tenga elementos, un for loop ejecutará el código
 hasta que lleguemos al final del carrito... */